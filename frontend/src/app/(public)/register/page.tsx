...
export default function RegisterPage() {
  ...
  return (
    <>
      <SeoHead title={t('auth.registerTitle')} description="注册圣诺联合账号，获取智慧招采、可信数据空间、AI 应用等企业数字化服务。" path="/register" />
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <Link href="/">
            <img src="/logo.png" alt="圣诺联合" className="h-12 w-auto mx-auto" />
          </Link>
